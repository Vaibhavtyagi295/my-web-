...
slideshow();
var image=["This project is created using HTML,CSS,GSAP","This project is created using HTML,CSS,GSAP","This project is created using HTML,CSS,GSAP,LOCOMOTIVE JS"];
var b =0;
function slide(){
